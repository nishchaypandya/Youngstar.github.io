                        ...
                        <form method="post" enctype="multipart/form-data">
							<div class="card-body card-block">
							   <div class="form-group">
								...
								<div class="form-group">
									<label for="categories" class=" form-control-label">Service Title</label>
									<input type="text" name="name" placeholder="Enter product name" class="form-control" required value="<?php echo $name?>">
								</div>
								<div class="form-group">
									<label for="categories" class=" form-control-label">Good in Services</label>
								...
								<div class="form-group">
									<label for="categories" class=" form-control-label">price with Discount </label>
									<input type="text" name="price" placeholder="Enter product price" class="form-control" required value="<?php echo $price?>">
								</div>
								
								<div class="form-group">
									<label for="categories" class=" form-control-label">avilable qty</label>
								...
								<div class="form-group">
									...
									<textarea name="description" placeholder="Enter product description and contact detials" class="form-control" required><?php echo $description?></textarea>
								</div>
